...
sequence_length = 30
dropout_prob = 0.5
save_path = 'lstm_model_weights.pth'
...
def train_model(model, train_loader, valid_loader, criterion, optimizer, num_epochs, device):
    ...
    for epoch in range(num_epochs):
        ...
        print(f'Validation Perplexity: {calculate_perplexity(valid_loss):.4f}\n')
...
def main():
    # Prepare Data
    file_path = '/home/tanmay.somkuwar/implementation/punjabi.txt'
...
def main():
    ...
    # Train and evaluate
    train_model(model, train_loader, valid_loader, criterion, optimizer, num_epochs, device, model_save_path)
